...
include("VMapGenerator");
include("VFractalWorld");
include("VFeatureGenerator");
include("VTerrainGenerator");

------------------------------------------------------------------------------
function GetMapScriptInfo()
	local world_age, temperature, rainfall, sea_level, resources = GetCoreMapOptions()
	return {
		Name = "Vanilla Pangaea v1.0",
		Description = "A version of Pangaea with coal and aluminum guaranteed.",
		IsAdvancedMap = false,
